...
const axiosDefaults = {
  baseURL: 'http://192.168.1.158:1337/api',
  timeout: 5000,
  headers: {
    'Content-Type': 'application/json',
  },
};
export const imageuri = 'http://192.168.1.158:1337/public/images/';
export const fileuri = 'http://192.168.1.158:1337/public/files/';
